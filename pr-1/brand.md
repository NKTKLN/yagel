...
<img src="assets/yagel-lockup.svg" alt="Логоблок «Ягель»: знак ростка и надпись ЯГЕЛЬ" width="148" height="48">
...
| [`assets/yagel-lockup.svg`](assets/yagel-lockup.svg) | основной логоблок: знак и слово вывороткой на чернильной плашке | шапки, комбинированное обозначение |

### Основной логоблок

<img src="assets/yagel-lockup.svg" alt="Логоблок «Ягель»: знак ростка и надпись ЯГЕЛЬ" width="148" height="48">

Плашка 148×48 со скруглением 10 (⅕ высоты), залита чернилами; знак и слово — выворотка.
Знак 28×28 с отступом 12 от края плашки, зазор до слова 10. Надпись — Golos Text 800,
кегль 20, трекинг +0.14em. Пропорции сохраняются при любом масштабе.
